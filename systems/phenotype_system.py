...
class BothNewModularCo2WiBiPhenotypeSystem :
    ...
    def __str__(self) :
        return "Modular BothPhenotypeSystem, build the phenotype from the genome with co dominance, with 2 outputs, without biases and and with new genome in 3d not 5... with other logical rules "
