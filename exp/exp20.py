...
from systems.phenotype_system import BothOtherEnvModular2WiBiPhenotypeSystem
...
def main() : 
    ...
    for k in range(config.number_of_config) :
        ...
        for i in range(config.number_of_exp) : 
            ...
            phenotype_system = BothOtherEnvModular2WiBiPhenotypeSystem(config, entity_manager, genome_operator, network_manager, substrate_builder, phenotype_builder, function_pool, robot_generator, robot_simulator, results_manager, type_genome, type_env)
