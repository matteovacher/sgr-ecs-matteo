...
from systems.phenotype_system import BothModular2WiBiPhenotypeSystem
...
# ici c est dominance classique ie random choice si tie, ensuite c est aussi le substrat a 11 donc bien pense a modif le fichier config
...
def main() : 
    ...
    for k in range(config.number_of_config) :
        ...
        for i in range(config.number_of_exp) : 
            ...
            phenotype_system = BothModular2WiBiPhenotypeSystem(config, entity_manager, genome_operator, network_manager, substrate_builder, phenotype_builder, function_pool, robot_generator, robot_simulator, results_manager, type_genome)
