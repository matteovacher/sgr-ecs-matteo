...
from systems.phenotype_system import BothSignalUniformEnvModular2WiBiPhenotypeSystem
from systems.evaluation_system import BothEnvEvaluationSystem
from systems.save_gen_system import BothSaveGenSystem
from systems.reproduction_system import BothSignalUniformMeiosisModularReproductionSystem
...
def main() : 
    ...
    for k in range(config.number_of_config) :
        ...
        for i in range(config.number_of_exp) : 
            ...
            reproduction_system = BothSignalUniformMeiosisModularReproductionSystem(config, genome_operator, entity_manager, function_pool, results_manager, type_genome)
...
def render() : 
    ...
    while exit == False : 
        ...
        if action == 'bodies' :
            ...
            images, _ = robot_simulator.simulate_render_mode_env(body.body, controller_network, network_manager, config.n_steps[type_env], type_env)
