...
def main() :
    ...
    phenotype_system = BothEnvPhenotypeSystem(config, entity_manager, genome_operator, network_manager, substrate_builder, phenotype_builder, function_pool, robot_generator, robot_simulator, results_manager, type_genome, type_env)
    ...
    time2 = time.time()
    print("Total time : ", time2 - time1)
    print("Whole simulation took : ", time2 - time1 + total_time)
