...
from systems.phenotype_system import BothNewModular2WiBiPhenotypeSystem
...
# this one will be same as exp 11 but this time 3d substrate and also basic dominance system and not codominance 
...
def main() : 
    ...
    for k in range(config.number_of_config) :
        ...
        for i in range(config.number_of_exp) : 
            ...
            phenotype_system = BothNewModular2WiBiPhenotypeSystem(config, entity_manager, genome_operator, network_manager, substrate_builder, phenotype_builder, function_pool, robot_generator, robot_simulator, results_manager, type_genome)
